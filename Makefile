...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/11/24 15:12:38 by vvlasenk          #+#    #+#              #
#    Updated: 2016/11/24 15:12:40 by vvlasenk         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
FILE_SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
			...
			ft_strnew.c ft_strdel.c ft_strclr.c ft_striter.c ft_striter.c \
...
FILE_O =	ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
			...
			ft_strnew.o ft_strdel.o ft_strclr.o ft_striter.o ft_striter.o \
